...
class PiperInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        inputs["prompt"]  = "Move the cup into the box, place it properly, and then return to the original position."
        #inputs["prompt"]  = "Move the green tape into the box, place it properly, and then return to the original position."
